...
![img](../images/vX7T6E.png)

#### 使用 ACK 号确认网络包已收到

> 序号和 ACK 号的用法

![img](../images/NcWHwE.png)

> 数据双向传输时的情况

![img](../images/enCMDG.png)

> 序号和 ACK 号的交互

![img](../images/7ri9Nx.png)
...
![img](../images/sngZCn.png)

> 发送方、接收方和转发设备

![img](../images/PigTAV.png)
...
![img](../images/C3GdKo.png)

> 交叉网线

![img](../images/ZwgFMk.png)
...
> 光纤的结构
![img](../images/SK8zmH.png)

> 光纤的通信原理

![img](../images/pDeAzS.png)
...
![img](../images/h9MP8b.png)

### 跨越运营商的网络包

> 运营商之间的路由信息交换

![img](../images/qCQWpW.png)

> 路由信息交换的类型

![img](../images/Fhht2W.png)
...
![img](../images/iglWS7.png)

> 负载均衡器

![img](../images/VNzctz.png)

> 缓存服务器工作流程

![img](../images/hVjUF1.png)

> 利用代理实现防火墙

![img](../images/RuPtoV.png)

> 缓存服务器的三种部署方式

![img](../images/fDGXca.png)

> 如何找到最近的缓存服务器

![img](../images/BNKwaj.png)
